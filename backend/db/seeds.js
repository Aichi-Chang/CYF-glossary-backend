        ...
        return Terms.create([
          {
            ...
            links: ['https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/200'],
            tags: ['http', 'status']
          }, {
            ...
            links: ['https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/201'],
            tags: ['http', 'status'] 
          }, {
            ...
            links: ['https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/300'],
            tags: ['http', 'stauts']
          }, {
            ...
            links: ['https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/401'],
            ...
            links: ['https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/404'],
            tags: ['http', 'error', 'status'] 
          }, {
            ...
            links: ['https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/406'],
            tags: ['http', 'error', 'status'] 
          }, {
            ...
            links: ['https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/500'],
            tags: ['http', 'error', 'status'] 
          }          
        ])
      })
